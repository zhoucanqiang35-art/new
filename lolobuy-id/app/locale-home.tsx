...
export function LocaleHome({locale}:{locale:Locale}){
  ...
  const featureCards=[
    ...
    {title:nav.categories,text:c.cards[1],href:locale==="en"?"/spreadsheet":p(locale,"/categories")},
