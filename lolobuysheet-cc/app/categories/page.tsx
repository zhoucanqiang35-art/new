...
export const metadata = { title: "LoloBuy Spreadsheet Categories | Product Discovery", description: "Browse ten FindSpreadsheet product categories before selecting a LoloBuy purchase route." };
