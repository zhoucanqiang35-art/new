...
export default function Search() {
  return <Suspense fallback={<main><SiteHeader /><section className="page-hero"><p className="eyebrow">SEARCH RESULTS</p><h1>Browse all results</h1></section></main>}><SearchResults /></Suspense>;
}
