...
const staticAssetPath =
  /^(?:\/assets\/|\/products\/)|\.(?:css|js|mjs|png|jpe?g|webp|gif|svg|ico|woff2?|ttf|otf|txt|xml|webmanifest)$/i;
...
export default {
  fetch(request, env, context) {
    ...
    // application routes, otherwise browsers can receive unstyled HTML.
