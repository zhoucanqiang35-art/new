...
export const guides: Guide[] = [
  ...
  {
    slug: "pikobuy-parcel-insurance-claim",
    eyebrow: "Insurance claims",
    title: "PikoBuy Parcel Insurance: Coverage, Evidence and Claim Checklist",
    seoTitle: "PikoBuy Parcel Insurance Claim Guide",
    description: "A practical PikoBuy parcel insurance claim guide covering lost parcels, delay compensation, exclusions, evidence and the terms to save before shipping.",
    readTime: "12 min read",
    updated: "Published 7 September 2026",
    publishedDate: "2026-09-07",
    modifiedDate: "2026-09-07",
    editorialNote: "Independent guide verified against PikoBuy's public agreements on 7 September 2026. It explains the published process, not an insurance promise or legal opinion. The live route, checkout and policy terms govern an actual claim.",
    visual: {
      src: "/pikobuy-insurance-claim-checklist.svg",
      alt: "PikoBuy parcel insurance claim evidence flow from route terms and warehouse records through tracking, delivery inspection and claim submission",
      caption: "Original claim-evidence flow. Save each record before moving to the next stage; evidence that disappears later is difficult to reconstruct.",
    },
    intro: [
      "A PikoBuy parcel insurance claim is not simply a request for the value of an order. The current User Registration Agreement says that compensation for a lost parcel may be available when insurance was purchased as the parcel order was submitted, and that the amount is linked to the insured value. It also says PikoBuy may communicate with the third-party logistics provider, while compensation follows that provider's standards.",
      "That wording creates three decisions before you ship: whether the selected route offers the protection you need, what value and events the policy actually covers, and whether you can prove the parcel's condition and timeline. Buying a checkbox without saving its terms leaves the most important questions unanswered when a parcel is late, damaged or missing.",
      "This guide separates loss, delay, damage and customs events, then builds a compact evidence file for each stage. PikoBuy does not publish one universal premium, deductible, payout limit, claim deadline or decision time on the public agreement page. Take those figures from the live parcel screen and current insurance terms.",
    ],
    sections: [
      {
        heading: "Start with what the public agreement actually promises",
        paragraphs: [
          "PikoBuy's agreement describes international transport as independently performed by third-party logistics providers chosen by the shopper. If a parcel problem occurs, the shopper may authorize PikoBuy to communicate and negotiate with the provider. Compensation is subject to the provider's standards, so support contact and the final coverage decision may involve different parties.",
          "The parcel-insurance clause is narrower than a delivery guarantee. It says an insurance company may compensate when a parcel is lost and insurance was purchased with the order, based on the insured amount. The selected policy and evidence still matter. Do not treat the insured amount as an automatic refund or assume product cost, freight, taxes and consequential losses are all included.",
          "PikoBuy publishes a separate delayed-delivery provision. Delay is measured after carrier handover against the published transit time of an insured route. The agreement excludes stated causes including customs action, weather, traffic control, strikes, regulatory changes, terrorism, robbery, war and other force majeure. Loss and delay therefore need separate checks.",
        ],
        bullets: [
          "Loss: check whether insurance was selected, the insured value and the policy definition of loss",
          "Delay: save the route's published transit basis, handover date and excluded causes",
          "Damage: confirm whether damage is covered at all and what delivery evidence is required",
          "Customs or prohibited goods: never assume insurance overrides legal or route restrictions",
        ],
      },
      {
        heading: "Capture the policy before paying for international shipping",
        paragraphs: [
          "The strongest claim file begins before dispatch. On the parcel confirmation screen, save the route name, carrier or logistics-provider name if shown, destination, product category, declared contents, parcel weight and dimensions, freight amount, insurance charge, insured value and every visible coverage label. Save the full terms or a dated PDF or screenshot, including exclusions and links. A cropped image showing only that insurance was selected cannot answer how loss is defined or when a claim must be filed.",
          "Read for five details: covered event, valuation rule, maximum benefit, required evidence and deadline. Also look for a deductible, inquiry period, product restrictions and the claim recipient. If the screen leaves a material question open, ask support in writing before paying and save the dated answer alongside the policy.",
          "Check the parcel contents against restrictions. PikoBuy's agreement says users bear the loss when a parcel contains internationally prohibited items or is lost for factors excluded by the insurance terms. Its public logistics notes also flag sensitive, battery, liquid, powder, food, medicine, fragile and other restricted categories. Route acceptance is not proof that a destination will admit the goods, and insurance should never be treated as a way to make an unlawful shipment safe.",
        ],
      },
      {
        heading: "Calculate the value still exposed after insurance",
        paragraphs: [
          "Before choosing a policy, write the total financial exposure in separate rows: product payment, seller-to-warehouse delivery, international freight and platform charges, insurance premium, destination tax or brokerage, and any cost of replacing the item. Then mark only the rows that the saved policy explicitly covers. The difference is your uninsured exposure. This prevents an insured-value figure from being mistaken for a promise to reimburse every cost connected with the order.",
          "Use the lower of the policy limit, insured amount and evidence-based valuation ceiling as a planning cap unless the terms say otherwise. This is a budgeting method, not a claim formula. Do not add expected profit, emotional value or freight unless expressly covered. PikoBuy separately disclaims indirect losses and unrealized benefits.",
          "If the uncovered amount is more than you could comfortably lose, reduce the parcel, separate high-risk goods, change the route or do not ship. Insurance is one control inside a larger decision; it does not repair a weak seller record, unclear QC, prohibited contents or an address error.",
        ],
      },
      {
        heading: "Build an evidence chain from warehouse to carrier handover",
        paragraphs: [
          "Keep the seller listing, exact option, payment, warehouse IDs, item count and QC photos. PikoBuy's shipping terms say forwarded goods are unpacked and inspected, while professional checks are unavailable for some products. These records can show what appeared to enter the parcel; they do not prove authenticity, internal performance or concealed defects.",
          "At parcel submission, save the packing instruction, measured weight and dimensions, parcel number, route, insured value and payment confirmation. If a packing photo or weight record is available, keep it. After dispatch, record the carrier handover date and the first tracking event. PikoBuy's beginner guide says tracking should appear within three days after shipment, but that statement is not a universal delivery promise. A missing first scan and a parcel that stops after multiple scans are different evidence problems.",
          "Maintain one timeline rather than scattered messages. Record the date, event, source and saved file for warehouse receipt, parcel submission, carrier acceptance, material scans, delivery attempts and support responses. Use the source's timezone where possible so the journey can be compared with the delay clock and inquiry deadline.",
        ],
        bullets: [
          "Order: seller link, option, quantity and payment evidence",
          "Warehouse: QC photos, item count and visible-condition notes",
          "Parcel: measured weight, dimensions, contents, route and insured value",
          "Transit: handover date, tracking number and dated carrier events",
          "Support: complete messages, attachments, case numbers and decisions",
        ],
      },
      {
        heading: "Inspect delivery before the evidence disappears",
        paragraphs: [
          "PikoBuy's agreement tells recipients to check the outer packaging carefully when signing and to contact customer service immediately if a problem arises. It also lists signed receipt and intact, unopened packaging without weight reduction among circumstances relevant to its liability exclusions. That does not establish one universal insurer requirement, but it makes the delivery moment important.",
          "Photograph every parcel side, label, seal and visible damage before discarding packaging. If local rules allow, record an opening that shows the label, seals, packing and item count. Keep packaging, damaged goods and accessories until the claim closes, and obtain a carrier damage or shortage note when available. The route terms determine which records are mandatory.",
          "Do not state that a damaged item is a lost parcel. Report the observable facts: crushed corner, torn seal, wet packaging, missing unit, or item damaged inside. Ask which coverage applies. PikoBuy's agreement says fragile goods deemed fragile by the logistics provider may leave the loss with the user, so ceramics, glass and irregular items require especially careful route and packing checks before shipment.",
        ],
      },
      {
        heading: "Submit a claim that the provider can audit",
        paragraphs: [
          "Open the inquiry or claim within the earliest deadline shown in the saved terms. PikoBuy's agreement lists failure to inquire or claim before the inquiry period expires as a circumstance in which it assumes no responsibility, but the public page does not provide one universal period. Do not wait for a social-media estimate. Ask support to confirm the applicable cutoff and case number in writing.",
          "Lead with the parcel number, route, carrier handover, last scan, claimed event, insured value and requested next step. Attach a chronological index of order, warehouse, parcel, tracking and delivery records. Use original files and do not exaggerate. For delay, identify the published transit basis; for loss, ask whether the provider has completed its trace and confirmed loss.",
          "Keep the request factual when PikoBuy is relaying it. Ask which third party is deciding, which policy clause applies, whether information is missing, and how the final amount was calculated. Save partial payments, account credits and the written decision. If a claim is rejected, request the cited exclusion and appeal route rather than resubmitting a different story.",
        ],
      },
      {
        heading: "Know when insurance is unlikely to solve the problem",
        paragraphs: [
          "Insurance cannot turn a seller dispute into transit loss. A wrong warehouse item belongs in QC and returns, not a parcel claim. Customs detention, confiscation or destruction can fall outside responsibility, especially for restricted goods. Address errors, inadequate packaging, user-caused loss and late inquiries may also change the outcome.",
          "The safest decision is made before the parcel moves: select lawful goods, verify the seller and exact variant, review QC, choose a route that accepts the product, save the insurance wording, and keep the uninsured amount affordable. If any of those checks fail, an insurance badge should not be the reason to proceed.",
        ],
      },
    ],
    internalLinks: [
      { label: "Diagnose a PikoBuy tracking delay", href: "/pikobuy-tracking-delay-diagnosis", note: "Separate label creation, carrier handover, line-haul, customs and last-mile events before making a claim." },
      { label: "Estimate the complete PikoBuy order cost", href: "/pikobuy-fees-total-cost", note: "Calculate the product, warehouse, freight and destination costs that may remain exposed." },
      { label: "Apply the PikoBuy buyer safety checklist", href: "/is-pikobuy-safe-buyer-checklist", note: "Check the domain, seller, payment, goods, QC and route before relying on insurance." },
      { label: "Read PikoBuy reviews as evidence", href: "/pikobuy-reviews-customer-experience-evidence", note: "Judge loss, delay and support stories by their route, dates and documents rather than a star rating." },
    ],
    faqHeading: "PikoBuy parcel insurance questions",
    faq: [
      {
        question: "Is PikoBuy parcel insurance automatic?",
        answer: "The public agreement describes compensation when parcel insurance was purchased while submitting the parcel order. Do not assume it is automatic; verify the selected route, insurance option, insured value and current terms before payment.",
      },
      {
        question: "Does insurance guarantee a full refund for a lost parcel?",
        answer: "No. PikoBuy says an insurance company may compensate based on the insured amount, while exclusions and the provider's standards apply. The public agreement does not promise reimbursement of every product, freight, tax or indirect cost.",
      },
      {
        question: "Who decides a PikoBuy parcel insurance claim?",
        answer: "PikoBuy says it may act as a communication agent with the third-party logistics provider. Compensation is subject to that provider's standards, so save the identity and terms of the route and insurer shown for your parcel.",
      },
      {
        question: "What evidence should I keep for a PikoBuy claim?",
        answer: "Keep the seller listing and payment, warehouse photos, parcel contents and measurements, route and insurance terms, insured value, tracking timeline, delivery packaging photos, support messages, case number and written decision.",
      },
    ],
    sources: [
      { label: "PikoBuy User Registration Agreement", href: "/sources#pikobuy-sources" },
