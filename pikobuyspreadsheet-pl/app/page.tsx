    ...
    <main>
      ...
      <section className="signal-strip">
        <div className="shell signal-grid">
          ...
          <div><b>21</b><span>evidence-led guides</span></div>
      ...
      <section className="section workflow-wrap">
        <div className="shell">
          ...
          <div className="source-note"><span>Source checked</span> PikoBuy official policies, contact page and beginner guide · Last verified 23 September 2026 <a href="/sources#pikobuy-sources">Review source record ↗</a></div>
        </div>
      </section>
