...
const staticMetadata: Record<string, { title: string; description: string }> = {
  ...
  "seo-articles": { title: "PikoBuy SEO Articles & Guides | Spreadsheet Europe", description: "Evidence-led PikoBuy guides covering fees, seller checks, spreadsheet use, QC photos, European shipping, EU VAT and customs, and returns." },
