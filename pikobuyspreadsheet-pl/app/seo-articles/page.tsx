...
export const metadata: Metadata = { title: "PikoBuy SEO Articles & Guides | Spreadsheet Europe", description: "Evidence-led PikoBuy guides covering fees, seller checks, QC photos, parcel weight, packaging, restrictions, returned parcels, European shipping, customs, tracking, insurance, safety and returns.", robots: indexableRobots, alternates: pageAlternates("/seo-articles") };
