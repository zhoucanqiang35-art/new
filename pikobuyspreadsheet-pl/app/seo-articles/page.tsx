...
export const metadata: Metadata = { title: "PikoBuy SEO Articles & Guides | Spreadsheet Europe", description: "Evidence-led PikoBuy guides covering fees, seller checks, QC photos, packaging, restrictions, returned or damaged parcels, European shipping, customs, tracking, insurance and returns.", robots: indexableRobots, alternates: pageAlternates("/seo-articles") };
