...
export const metadata: Metadata = { title: "PikoBuy SEO Articles & Guides | Spreadsheet Europe", description: "Evidence-led PikoBuy guides covering fees, seller checks, QC photos, European shipping, customs, tracking, safety, returns and customer reviews.", robots: indexableRobots, alternates: pageAlternates("/seo-articles") };
