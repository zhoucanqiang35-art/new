...
export const metadata: Metadata = { title: "PikoBuy SEO Articles & Guides | Spreadsheet Europe", description: "Evidence-led PikoBuy guides covering fees, seller checks, QC photos, European shipping, EU customs, tracking delays, buyer safety and returns.", robots: indexableRobots, alternates: pageAlternates("/seo-articles") };
