...
export const metadata: Metadata = { title: "PikoBuy SEO Articles & Guides | Spreadsheet Europe", description: "Evidence-led PikoBuy guides covering fees, seller checks, QC photos, packaging, restrictions, returned, damaged or incomplete parcels, European shipping, customs, tracking and insurance.", robots: indexableRobots, alternates: pageAlternates("/seo-articles") };
