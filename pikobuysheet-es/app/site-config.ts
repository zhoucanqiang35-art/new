...
export const localeCopies: LocaleCopy[] = [
  { code: "en", name: "English", nativeName: "English", nav: englishNav, eyebrow: "Independent PikoBuy spreadsheet guide · Updated for 2026", homeTitle: "PikoBuy Spreadsheet 2026: QC Finds, Categories, and How to Use It", homeIntro: "Browse PikoBuy spreadsheet categories, compare source links and QC checkpoints, and use a clearer workflow before saving any find.", browse: "Browse PikoBuy spreadsheet finds", research: "How to use the spreadsheet", independent: "Independent informational site. Not affiliated with PikoBuy.", language: "Language" },
