    ...
    <main className="home-page">
      ...
      <section className="updates-section" id="updates">
        <div className="update-copy">
          <p>{copy.nav.updates} / {isEnglish ? "AUG 13, 2026" : "AUG 06, 2026"}</p>
        ...
        <div className="update-log">
          {isEnglish && <div><time>AUG 13</time><span><b>PikoBuy tracking status guide published</b><small>A 1,688-word post-dispatch workflow covers first scans, quiet tracking, route delays, exceptions, support evidence and delivery checks.</small><Link href="/seo-articles/pikobuy-tracking-status-guide">Read the guide →</Link></span><i>NEW</i></div>}
