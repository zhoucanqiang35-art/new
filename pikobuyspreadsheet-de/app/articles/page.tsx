...
const articles = [
  ...
  { tag: "Shipping calculation", title: "PikoBuy Shipping Estimate and Volumetric Weight: A Practical Guide", summary: "How to compare actual and volumetric weight, replace guesses with packed measurements and read a live route before paying.", href: "/articles/shipping-estimate-volumetric-weight", time: "10 min" },
