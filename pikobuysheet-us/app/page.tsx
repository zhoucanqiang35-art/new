...
const featuredDetails = [
  { category: "Shoes", title: "Shoe listing checks", checks: "Model name, selected size, construction, outsole and visible images.", slug: "shoes" },
  { category: "Hoodies", title: "Hoodie listing checks", checks: "Measurements, fabric information, ribbing, visible print or embroidery.", slug: "hoodies-sweaters" },
  { category: "Electronics", title: "Electronics listing checks", checks: "Model, compatibility, selected variant and included accessories where shown.", slug: "underwear-underpants" },
];
...
export default function Home() {
  ...
  const openDatabaseSearch = (event: FormEvent) => {
    ...
    const url = new URL("https://findspreadsheet.com/AllProducts/");
    ...
    <main>
      ...
      <section id="details" className="details-section">
        ...
        <div className="detail-grid">{featuredDetails.map((product, index) => <article key={product.title} className="detail-card">
          ...
          <a href={`/product-categories/${product.slug}`}>Open category research <b>↗</b></a>
        </article>)}</div>
