...
const staticMetadata: Record<string, { title: string; description: string }> = {
  ...
  "seo-articles": { title: "PikoBuy SEO Articles & Guides | Spreadsheet Europe", description: "Evidence-led PikoBuy guides covering fees, seller checks, QC photos, parcel weight, packaging, restricted items, European shipping, customs, tracking, insurance, safety and returns." },
