...
import { categories } from "../content-restored";
import SiteFooter from "../site-footer";
import SiteHeader from "../site-header";
import { indexableRobots, pageAlternates } from "../seo";

export const metadata: Metadata = { title: "PikoBuy Product Categories | Spreadsheet Europe", description: "Browse focused PikoBuy spreadsheet categories and open the matching live FindSpreadsheet collection.", robots: indexableRobots, alternates: pageAlternates("/product-categories") };
