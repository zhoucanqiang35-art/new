...
export const faqContent: Record<Lang, FaqEntry[]> = {
  en: [
    ...
    { question: "How long is free warehouse storage?", answer: "LoloBuy’s public service description currently advertises 90 days of free storage. Check the live warehouse rules and item dates because policies and extended-storage charges can change." },
  ...
  de: [
    ...
    { question: "Wie lange ist die Lagerung kostenlos?", answer: "LoloBuy wirbt derzeit öffentlich mit 90 Tagen kostenloser Lagerung. Prüfe die aktuellen Lagerregeln und Artikeldaten, da sich Gebühren ändern können." },
  ...
  fr: [
    ...
    { question: "Combien de temps le stockage est-il gratuit ?", answer: "La présentation publique de LoloBuy annonce actuellement 90 jours gratuits. Vérifiez les règles et dates actives, car frais et conditions peuvent évoluer." },
  ...
  es: [
    ...
    { question: "¿Cuánto dura el almacenamiento gratuito?", answer: "La descripción pública de LoloBuy anuncia actualmente 90 días gratis. Revisa las reglas y fechas activas porque las condiciones pueden cambiar." },
  ...
  it: [
    ...
    { question: "Quanto dura il deposito gratuito?", answer: "La descrizione pubblica LoloBuy pubblicizza attualmente 90 giorni gratuiti. Controlla regole e date live perché le condizioni possono cambiare." },
  ...
  nl: [
    ...
    { question: "Hoe lang is opslag gratis?", answer: "LoloBuy adverteert publiek momenteel 90 dagen gratis opslag. Controleer de actuele regels en data omdat voorwaarden kunnen wijzigen." },
  ...
  pl: [
    ...
    { question: "Jak długo magazynowanie jest bezpłatne?", answer: "LoloBuy publicznie reklamuje obecnie 90 dni bezpłatnego przechowywania. Sprawdź aktualne zasady i daty, bo warunki mogą się zmienić." },
  ...
  pt: [
    ...
    { question: "Quanto tempo o armazenamento é gratuito?", answer: "A descrição pública da LoloBuy anuncia atualmente 90 dias grátis. Verifique regras e datas ativas porque as condições podem mudar." },
  ...
  sv: [
    ...
    { question: "Hur länge är lagring gratis?", answer: "LoloBuy annonserar offentligt för närvarande 90 dagars gratis lagring. Kontrollera aktuella regler och datum eftersom villkor kan ändras." },
