    ...
    <>
      ...
      <section className="shell research-grid" aria-labelledby="latest-title">
        <div className="editorial-panel">
          ...
          {lang === "en" && <p className="latest-research"><strong>Latest research · 11 Aug 2026</strong><Link href="/seo-articles/lolobuy-return-refund-process">LoloBuy return and refund process by order status →</Link></p>}
