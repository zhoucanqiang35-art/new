    ...
    <>
      ...
      <section className="shell research-grid" aria-labelledby="latest-title">
        <div className="editorial-panel">
          ...
          {lang === "en" && <p className="latest-research"><strong>Latest research · 12 Aug 2026</strong><Link href="/seo-articles/how-to-track-lolobuy-parcel">How to track a LoloBuy parcel across carrier handoffs →</Link></p>}
