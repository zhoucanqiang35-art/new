...
export const sectionItemTitles: Record<Locale, Record<Section, string[]>> = {
  en: {
    ...
    guides: ["Beginner research workflow", "QC photo checklist", "Shipping cost planning", "Product-link verification"],
    articles: ["What is a Pikobuy Spreadsheet?", "How to use a Pikobuy Spreadsheet in 2026", "Pikobuy QC photos: a practical review guide", "Pikobuy shipping cost: what changes the final quote", "Pikobuy Payment Guide: Two Checkout Stages", "Pikobuy Warehouse and Parcel Consolidation Guide", "Pikobuy Return Policy: 120-Hour Warehouse Guide", "Pikobuy Tracking Guide: Order & Parcel Status", "Pikobuy Customs and Taxes 2026: EU, UK, US & Canada", "Pikobuy Restricted Items Guide: Batteries & Liquids"],
    updates: ["Category structure refreshed", "Current-link checks clarified", "QC guide expanded", "Language pages introduced"],
  ...
  de: {
    ...
    articles: ["Was ist ein Pikobuy Spreadsheet?", "So nutzt du ein Pikobuy Spreadsheet 2026", "Pikobuy-QC-Fotos richtig prüfen", "Pikobuy-Versandkosten verständlich erklärt", "Pikobuy-Zahlung: zwei Checkout-Phasen", "Pikobuy-Lager und Paketkonsolidierung", "Pikobuy-Rückgabe: 120-Stunden-Leitfaden", "Pikobuy-Tracking: Bestell- und Paketstatus", "Pikobuy-Zoll und Steuern: EU, UK, USA und Kanada", "Pikobuy-Versandbeschränkungen: Batterien und Flüssigkeiten"],
  ...
  fr: {
    ...
    articles: ["Qu’est-ce qu’un Pikobuy Spreadsheet ?", "Comment utiliser un Pikobuy Spreadsheet en 2026", "Photos QC Pikobuy : guide de vérification", "Frais d’expédition Pikobuy : comprendre le devis", "Paiement Pikobuy : deux étapes de règlement", "Entrepôt Pikobuy et consolidation des colis", "Retours Pikobuy : guide des 120 heures", "Suivi Pikobuy : statut des commandes et colis", "Douanes et taxes Pikobuy : UE, Royaume-Uni, États-Unis et Canada", "Restrictions d’expédition Pikobuy : batteries et liquides"],
  ...
  es: {
    ...
    articles: ["¿Qué es una hoja Pikobuy?", "Cómo usar una hoja Pikobuy en 2026", "Fotos QC de Pikobuy: guía práctica", "Coste de envío de Pikobuy: qué cambia el precio", "Pago de Pikobuy: dos etapas de cobro", "Almacén Pikobuy y consolidación de paquetes", "Devoluciones Pikobuy: guía de 120 horas", "Seguimiento Pikobuy: estado de pedidos y paquetes", "Aduanas e impuestos de Pikobuy: UE, Reino Unido, EE. UU. y Canadá", "Restricciones de envío de Pikobuy: baterías y líquidos"],
  ...
  it: {
    ...
    articles: ["Che cos’è un Pikobuy Spreadsheet?", "Come usare un Pikobuy Spreadsheet nel 2026", "Foto QC Pikobuy: guida pratica", "Spedizione Pikobuy: cosa cambia il preventivo", "Pagamento Pikobuy: due fasi di checkout", "Magazzino Pikobuy e consolidamento dei pacchi", "Resi Pikobuy: guida alle 120 ore", "Tracking Pikobuy: stato di ordini e pacchi", "Dogana e tasse Pikobuy: UE, Regno Unito, USA e Canada", "Restrizioni di spedizione Pikobuy: batterie e liquidi"],
  ...
  pl: {
    ...
    articles: ["Czym jest Pikobuy Spreadsheet?", "Jak korzystać z Pikobuy Spreadsheet w 2026 roku", "Zdjęcia QC Pikobuy: praktyczny poradnik", "Koszt wysyłki Pikobuy: co wpływa na wycenę", "Płatność Pikobuy: dwa etapy rozliczenia", "Magazyn Pikobuy i konsolidacja paczek", "Zwroty Pikobuy: przewodnik po 120 godzinach", "Śledzenie Pikobuy: status zamówień i paczek", "Cło i podatki Pikobuy: UE, Wielka Brytania, USA i Kanada", "Ograniczenia wysyłki Pikobuy: baterie i płyny"],
  ...
  nl: {
    ...
    articles: ["Wat is een Pikobuy Spreadsheet?", "Een Pikobuy Spreadsheet gebruiken in 2026", "Pikobuy QC-foto’s: praktische controlegids", "Pikobuy-verzendkosten: wat bepaalt de prijs", "Pikobuy-betaling: twee afrekenmomenten", "Pikobuy-magazijn en pakketconsolidatie", "Pikobuy-retourbeleid: gids voor 120 uur", "Pikobuy-tracking: bestel- en pakketstatus", "Pikobuy-douane en belastingen: EU, VK, VS en Canada", "Pikobuy-verzendbeperkingen: batterijen en vloeistoffen"],
  ...
  pt: {
    ...
    articles: ["O que é uma Pikobuy Spreadsheet?", "Como usar uma Pikobuy Spreadsheet em 2026", "Fotos QC Pikobuy: guia prático", "Envio Pikobuy: o que altera o orçamento", "Pagamento Pikobuy: duas etapas de checkout", "Armazém Pikobuy e consolidação de encomendas", "Devoluções Pikobuy: guia de 120 horas", "Rastreamento Pikobuy: estado de pedidos e encomendas", "Alfândega e impostos Pikobuy: UE, Reino Unido, EUA e Canadá", "Restrições de envio Pikobuy: baterias e líquidos"],
