...
export const sectionItemSlugs: Record<Exclude<Section, "categories">, string[]> = {
  ...
  articles: ["what-is-a-pikobuy-spreadsheet", "how-to-use-pikobuy-spreadsheet-2026", "pikobuy-qc-photo-guide", "pikobuy-shipping-cost", "pikobuy-payment-guide", "pikobuy-warehouse-consolidation-guide", "pikobuy-return-policy-guide", "pikobuy-tracking-guide"],
...
export const sectionItemTitles: Record<Locale, Record<Section, string[]>> = {
  en: {
    ...
    guides: ["Beginner research workflow", "QC photo checklist", "Shipping cost planning", "Product-link verification"],
    articles: ["What is a Pikobuy Spreadsheet?", "How to use a Pikobuy Spreadsheet in 2026", "Pikobuy QC photos: a practical review guide", "Pikobuy shipping cost: what changes the final quote", "Pikobuy Payment Guide: Two Checkout Stages", "Pikobuy Warehouse and Parcel Consolidation Guide", "Pikobuy Return Policy: 120-Hour Warehouse Guide", "Pikobuy Tracking Guide: Order & Parcel Status"],
    updates: ["Category structure refreshed", "Current-link checks clarified", "QC guide expanded", "Language pages introduced"],
  ...
  pt: {
    ...
    articles: ["O que é uma Pikobuy Spreadsheet?", "Como usar uma Pikobuy Spreadsheet em 2026", "Fotos QC Pikobuy: guia prático", "Envio Pikobuy: o que altera o orçamento", "Pagamento Pikobuy: duas etapas de checkout", "Armazém Pikobuy e consolidação de encomendas", "Devoluções Pikobuy: guia de 120 horas", "Rastreamento Pikobuy: estado de pedidos e encomendas"],
