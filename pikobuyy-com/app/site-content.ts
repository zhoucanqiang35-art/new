...
export const sectionItemTitles: Record<Locale, Record<Section, string[]>> = {
  en: {
    ...
    guides: ["Beginner research workflow", "QC photo checklist", "Shipping cost planning", "Product-link verification"],
    articles: ["What is a Pikobuy Spreadsheet?", "How to use a Pikobuy Spreadsheet in 2026", "Pikobuy QC photos: a practical review guide", "Pikobuy shipping cost: what changes the final quote", "Pikobuy Payment Guide: Two Checkout Stages"],
    updates: ["Category structure refreshed", "Current-link checks clarified", "QC guide expanded", "Language pages introduced"],
  ...
  de: {
    ...
    articles: ["Was ist ein Pikobuy Spreadsheet?", "So nutzt du ein Pikobuy Spreadsheet 2026", "Pikobuy-QC-Fotos richtig prüfen", "Pikobuy-Versandkosten verständlich erklärt", "Pikobuy-Zahlung: zwei Checkout-Phasen"],
  ...
  fr: {
    ...
    articles: ["Qu’est-ce qu’un Pikobuy Spreadsheet ?", "Comment utiliser un Pikobuy Spreadsheet en 2026", "Photos QC Pikobuy : guide de vérification", "Frais d’expédition Pikobuy : comprendre le devis", "Paiement Pikobuy : deux étapes de règlement"],
  ...
  es: {
    ...
    articles: ["¿Qué es una hoja Pikobuy?", "Cómo usar una hoja Pikobuy en 2026", "Fotos QC de Pikobuy: guía práctica", "Coste de envío de Pikobuy: qué cambia el precio", "Pago de Pikobuy: dos etapas de cobro"],
  ...
  it: {
    ...
    articles: ["Che cos’è un Pikobuy Spreadsheet?", "Come usare un Pikobuy Spreadsheet nel 2026", "Foto QC Pikobuy: guida pratica", "Spedizione Pikobuy: cosa cambia il preventivo", "Pagamento Pikobuy: due fasi di checkout"],
  ...
  pl: {
    ...
    articles: ["Czym jest Pikobuy Spreadsheet?", "Jak korzystać z Pikobuy Spreadsheet w 2026 roku", "Zdjęcia QC Pikobuy: praktyczny poradnik", "Koszt wysyłki Pikobuy: co wpływa na wycenę", "Płatność Pikobuy: dwa etapy rozliczenia"],
  ...
  nl: {
    ...
    articles: ["Wat is een Pikobuy Spreadsheet?", "Een Pikobuy Spreadsheet gebruiken in 2026", "Pikobuy QC-foto’s: praktische controlegids", "Pikobuy-verzendkosten: wat bepaalt de prijs", "Pikobuy-betaling: twee afrekenmomenten"],
  ...
  pt: {
    ...
    articles: ["O que é uma Pikobuy Spreadsheet?", "Como usar uma Pikobuy Spreadsheet em 2026", "Fotos QC Pikobuy: guia prático", "Envio Pikobuy: o que altera o orçamento", "Pagamento Pikobuy: duas etapas de checkout"],
