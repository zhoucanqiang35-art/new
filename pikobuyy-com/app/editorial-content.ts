...
export const articleEntries: Record<string, EditorialEntry> = {
  ...
  "pikobuy-tracking-guide": {
    ...
    reviewed: "Fact-checked Aug 7, 2026",
    readingTime: "12 min read",
    ...
    visual: {
      ...
      caption: "Original Pikobuyy tracking map based on Pikobuy's public Beginner's Guide, Shipping Policy and Contact page reviewed on August 7, 2026.",
      width: 1200,
      height: 630,
    },
    relatedLinks: [
